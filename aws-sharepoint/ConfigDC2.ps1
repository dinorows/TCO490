...
$DomainAdmin = 'Domain\User' -replace 'Domain',$DomainNetBIOSName -replace 'User','Administrator'
...
$Credentials = (New-Object PSCredential($DomainAdmin,(ConvertTo-SecureString $ADAdminPassword -AsPlainText -Force)))
