...
$ADAdminPassword = $ADAdminSecParam
...
$Credentials = (New-Object PSCredential('Administrator',(ConvertTo-SecureString $ADAdminPassword -AsPlainText -Force)))
...
$AltCredentials = (New-Object PSCredential('Administrator',(ConvertTo-SecureString $AltUserPassword -AsPlainText -Force)))
...
$RestoreCredentials = (New-Object PSCredential('Administrator',(ConvertTo-SecureString $RestoreModePassword -AsPlainText -Force)))
...
Configuration ConfigDC1 {
    ...
    Node 'localhost' {
        ...
        xADGroup AddAdminToDomainAdminsGroup {
            ...
            GroupScope = 'Global'
            Category = 'Security'
            MembersToInclude = @("Administrator", "Administrator")
            Ensure = 'Present'
            Credential = $Credentials
